  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-[430px] flex-col bg-background px-5 pb-[82px] pt-3">
      ...
      <div className="mt-[85.5px] flex flex-col items-center">
        ...
        <div className="relative mt-[19px] size-[120px] rounded-full bg-2light-grey">
          <div className="absolute left-1/2 top-1/2 size-20 -translate-x-1/2 -translate-y-1/2">
            <div className="absolute left-1/2 top-1/2 h-[70px] w-[47.994px] -translate-x-1/2 -translate-y-1/2 overflow-hidden">
              <img
                src={characterLay}
                alt=""
          ...
          <button
            ...
            className="absolute left-[82px] top-[92px] size-7"
          >
